...
```{r, echo=FALSE}
knitr::kable(list_extracted_levels_datasets[['pidahi']][['tenacidad_level']], caption = 'Nivel de Tenacidad', digits = 1)
```
...
```{r, echo=FALSE}
knitr::kable(list_extracted_levels_datasets[['pidahi']][['esfuerzo_level']], caption = 'Nivel de Esfuerzo', digits = 1)
```
...
```{r, echo=FALSE}
knitr::kable(list_extracted_levels_datasets[['pidahi']][['preocupacion_level']], caption = 'Nivel de Preocupacion', digits = 1)
```
...
```{r, echo=FALSE}
list_by_school_levels_percents_tables[['pidahi']][['tenacidad_level']][['graph']]
```

### Percent-Levels Augusto Effort

```{r, echo=FALSE}
list_by_school_levels_percents_tables[['pidahi']][['esfuerzo_level']][['graph']]
```

### Percent-Levels Augusto Preoccupation

```{r, echo=FALSE}
list_by_school_levels_percents_tables[['pidahi']][['preocupacion_level']][['graph']]
```
...
```{r, echo=FALSE}
list_by_school_mean_graphs[['pidahi']][['Tenacidad']]
```

### Example Augusto Esfuerzo

```{r, echo=FALSE}
list_by_school_mean_graphs[['pidahi']][['Esfuerzo']]
```

### Example Augusto Preocupacion

```{r, echo=FALSE}
list_by_school_mean_graphs[['pidahi']][['Preocupacion']]
```

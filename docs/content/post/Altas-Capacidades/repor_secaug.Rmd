...
```{r, echo=FALSE}
knitr::kable(list_extracted_levels_datasets[['secaugusto']][['tenacidad_level']], caption = 'Nivel de Tenacidad', digits = 1)
```
### Table Augusto Esfuerzo

```{r, echo=FALSE}
knitr::kable(list_extracted_levels_datasets[['secaugusto']][['esfuerzo_level']], caption = 'Nivel de Esfuerzo', digits = 1)
```
### Table Augusto Preocupacion

```{r, echo=FALSE}
knitr::kable(list_extracted_levels_datasets[['secaugusto']][['preocupacion_level']], caption = 'Nivel de Preocupacion', digits = 1)
```
...
```{r, echo=FALSE}
knitr::kable(list_by_school_mean_sd_tables[['secaugusto']], caption = 'secaugusto', digits = 1)
```

...
#print(cor(temperament_numeric, torrance_numeric), digits=1)
...
cor_mat[cor_test_mat > 0.05] <- NA
print(cor_mat)
cor_test_mat[cor_test_mat > 0.05] <- NA
print(cor_test_mat)
}
```
...
#scales <- identify_and_make_na_outlaiers(scales)
#scales <- impute_any_dataset_mice(scales, 10, 5)

---
#TEST GIT
title: "RESULTADOS CORRELACIONES M. F. SERRANO 2022"
output:
  pdf_document
---
...
cor_mat <- cor(temperament_numeric, raven_numeric)
library(psych)
cor_test_mat <- corr.test(temperament_numeric, raven_numeric)$p    # Apply corr.test function
cor_test_mat                         # Print matrix of p-values

library(corrplot)
return(corrplot(cor_mat,                    # Draw corrplot with p-values
	p.mat = cor_test_mat,
	insig = "p-value")
)
}
